...
export function createPatchFunction(backend) {
  ...
  for (i = 0; i < hooks.length; ++i) {
    // cbs['update’]=[] 存储多个模块的钩子函数 cbs['update'] [updateAttrs, updateClass, update...]
    cbs[hooks[i]] = []
  ...
  function createElm(
    ...
    // 表明vnode之前渲染过，ownerArray是vnode的子节点
